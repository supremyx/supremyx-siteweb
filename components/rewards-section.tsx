...
const rewards: Reward[] = [
  {
    ...
    description: "1ère place du tournoi Clan Battles League CI",
    prize: "360 UC",
  ...
  },
  {
    ...
    description: "2ème place du tournoi Clan Battles League CI",
    prize: "240 UC",
  ...
  },
  {
    ...
    description: "3ème place du tournoi Clan Battles League CI",
    prize: "120 UC",
  ...
  {
    id: "5",
    title: "Vice-Champion Duo Masters",
    description: "2ème place du tournoi Duo Masters",
    prize: "160 UC",
    icon: <Trophy className="size-6" />,
    tier: "silver",
    category: "Duo",
  ...
  },
  {
    id: "8",
    title: "Clutch Master",
    description: "Récompense pour les actions clutch décisives",
    prize: "30 UC",
          ...
          <CardContent className="flex flex-col items-center gap-4 py-8 text-center sm:flex-row sm:text-left">
            ...
            <div className="flex-1">
              ...
              <p className="mt-1 text-muted-foreground">
                ...
                Assurez-vous que votre ID PUBG est correct lors de l&apos;inscription !
              </p>
            </div>
          </CardContent>
        </Card>
