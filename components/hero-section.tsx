      ...
      <div className="relative mx-auto max-w-7xl px-4 py-20 sm:px-6 sm:py-32 lg:px-8">
        <div className="text-center">
          ...
          <div className="mx-auto mt-16 grid max-w-3xl grid-cols-2 gap-6 sm:grid-cols-4">
            <StatCard icon={Users} value="500+" label="Joueurs" />
            <StatCard icon={Trophy} value="50+" label="Tournois" />
            <StatCard icon={Target} value="100+" label="Équipes" />
            <StatCard icon={Zap} value="24/7" label="Compétitions" />
          </div>
        </div>
      </div>
    </section>
